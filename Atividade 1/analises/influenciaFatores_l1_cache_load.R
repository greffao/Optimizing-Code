...
#Vetor de resultados
L1_Dcache_Load = c(6690900209, 6691234947, 10802971861,10802557562)

#adiciona os resultados no planejamento de experimentos)
plan.atualizado = add.response(design = plan.person, response = L1_Dcache_Load)
...
plan.formula = lm(plan.atualizado$L1_Dcache_Load~(plan.atualizado$Tecnica*plan.atualizado$Alocacao))
