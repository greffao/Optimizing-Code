...
fatores <- list(
  Tecnica = c("Sem_Otimizacao", "Loop_Unrolling"),
...
#Vetor de resultados
Branch_Instructions = c(539130712,282924276,549757945,293865948)

#adiciona os resultados no planejamento de experimentos)
plan.atualizado = add.response(design = plan.person, response = Branch_Instructions)
...
plan.formula = lm(plan.atualizado$Branch_Instructions~(plan.atualizado$Tecnica*plan.atualizado$Alocacao))
